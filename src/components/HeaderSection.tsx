  ...
  return (
    <div className="text-center space-y-4 animate-fade-in">
      ...
      <p className="text-sm text-muted-foreground max-w-4xl mx-auto">
        A parsed and formatted rendering of <a href="https://www.pnba.org/" className="text-primary underline hover:text-primary/80" target="_blank" rel="noopener noreferrer">PNBA</a> data provided by the American Booksellers Association (<a href="https://www.bookweb.org/indiebound/bestsellers/regional" className="text-primary underline hover:text-primary/80" target="_blank" rel="noopener noreferrer">available here</a>). We use this to track and switch our displays at <a href="https://portbooknews.com" className="text-primary underline hover:text-primary/80" target="_blank" rel="noopener noreferrer">Port Book and News</a>. This info is from the most-recently published list {bestsellerData?.date && `(for the week ending `}<span className="font-bold">{bestsellerData?.date || 'loading...'}</span>{bestsellerData?.date && `)`}.
      </p>
